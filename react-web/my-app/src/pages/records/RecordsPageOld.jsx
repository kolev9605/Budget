      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">{filteredRecords.length} transactions found</p>
          </div>
        ...
        <div className="space-y-4">
          {filteredRecords.map((record) => (
            <div key={record.id} className="bg-gray-800 p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow">
