...
const AccountsPage = ({ accounts }) => {
  ...
  const sampleAccounts = [
    ...
    { id: '2', name: 'Primary Credit Card', type: 'credit', balance: -1250.00, description: 'Visa Platinum **** 1234' },
    { id: '3', name: 'Savings Account', type: 'savings', balance: 15000.00, description: 'Bank of Example - 5% APY' },
  ];
