...
namespace Budget.Infrastructure.ColorGenerator
{
    public class ColorGenerator : IColorGenerator
    {
        private readonly string[] colourValues = new string[] {
            "#F44336",
            "#E57373",
            "#EF5350",
            "#F44336",
        ...
        private readonly HashSet<string> GeneratedColors;
        ...
        public ColorGenerator(ICategoryService categoryService)
        {
            ...
            this.GeneratedColors = new HashSet<string>();
            this.FillCollection();

            this.currentIndex = 0;
            Random rnd = new Random();
            this.colourValues = colourValues.OrderBy(x => rnd.Next()).ToArray();
        }
